...
export const ChatHeader = ({ chat }: { chat: Chat | Group | null }) => {
  ...
  console.log(isUserInfoModalOpen);
  return (
    <>
      <div
        className="border-b border-gray-200 dark:border-gray-700 p-4 flex items-center justify-between cursor-pointer"
      ...
      {/* user info modal */}
      {isUserInfoModalOpen && (
        <UserInfoModal setIsOpen={setUserInfoModalOpen} />
      )}
    </>
  );
};
